...
def reset_request():
    ...
    if form.validate_on_submit():
        ...
        flash('reset password instructions have been sent on your e-mail', 'info')
...
def reset_token(token):
    ...
    if user is None:
        flash('This is incorrect token', 'warning')
    ...
    if form.validate_on_submit():
        ...
        db.session.commit()
        flash('Your password is being updated!' 'You can log in now!', 'success')
        return redirect(url_for('users.login'))
